...
(define pop (rib 2 '() procedure-type))
(define skip (rib 3 '() procedure-type))
(define close (rib 4 '() procedure-type))
(define rib? (rib 5 '() procedure-type))
(define rib-car (rib 6 '() procedure-type))
(define rib-cdr (rib 7 '() procedure-type))
(define rib-tag (rib 8 '() procedure-type))
(define rib-set-car! (rib 9 '() procedure-type))
(define rib-set-cdr! (rib 10 '() procedure-type))
(define rib-set-tag! (rib 11 '() procedure-type))
(define eq? (rib 12 '() procedure-type))
...
(define read-u8 (rib 18 '() procedure-type))
(define write-u8 (rib 19 '() procedure-type))
