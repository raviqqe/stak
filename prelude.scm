...
(define-library (scheme inexact)
  ...
  (begin
    (define infinite? (primitive 17))
    (define nan? (primitive 18))
    (define sqrt (primitive 19))
    (define cos (primitive 20))
    (define sin (primitive 21))
    (define tan (primitive 22))
    (define acos (primitive 23))
    (define asin (primitive 24))
    (define atan (primitive 25))
