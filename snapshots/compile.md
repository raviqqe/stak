...
- constant procedure 2 #f
  ...
  - constant procedure 3 #f
    ...
    - call 2 #f quotient
    - call 2 #f list-tail
    - call 3 #f recursive procedure 0
  - set 1
  - get ||
  - get 3
  - call 1 #f ||
...
- constant procedure 0 #t
  ...
  - constant procedure 0 #f
    ...
    - if
      - constant ()
    - call 0 #f read-char
    - call 0 #f recursive procedure 0
    - call 2 #f cons
  - set 5
  - constant procedure 0 #f
    - call 0 #f read-char
    ...
    - constant procedure 1 #f
      ...
      - if
        ...
        - get 3
        - call 2 #f cons
        - call 1 #f recursive procedure 0
      - get 0
      - get 2
      - call 2 #f cons
      - call 1 #f recursive procedure 0
...
- constant procedure 2 #f
  ...
  - if
    - constant procedure 1 #f
      - get 4
      - get 1
      - call 2 #f recursive procedure 1
    - call 1 #f $$close
    - get 1
    - call 2 #f map
  - get 0
...
- constant procedure 1 #f
  ...
  - if
    ...
    - constant ()
    - call 2 #f cons
    - constant macro-context-set-global!
    - constant context
    - constant car
    - constant pair
    - constant ()
    ...
    - call 2 #f cons
    - constant compile
    - constant analyze-free-variables
    - constant optimize
    - constant expand-macros
    - constant expression
    - constant ()
