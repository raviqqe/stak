...
Bytecode files compress floating-point number literals in source codes. Literals keep 38-bit mantissas, or precision of about 11 significant decimal digits. Literals of magnitudes below 2^-985 lose their precision progressively, and ones below 2^-1023 become zeros.
